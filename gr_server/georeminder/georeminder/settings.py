"""
Django settings for georeminder project.
...
SECRET_KEY = 'django-insecure-6(myi^xew8_dndz7%jz+pu)u@!ct^9bbxxjcw=mpd)z@i@gfno'
...
WSGI_APPLICATION = 'georeminder.wsgi.application'
...
SOCIAL_AUTH_GOOGLE_SCOPE = ['profile', 'email']
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'social_oauth.pipeline.generate_jwt_token', 
)
